...
const DonorEditPopper = ({ donor, cb }) => {
  // console.log("this is donor in edir popper: ", donor)
  ...
  const handleDonorEdit = async (e, id, form_data) => {
    e.preventDefault();
                ...
                <Box sx={{ display: "flex", alignItems: "flex-end" }}>
                  ...
                  <form className="form-popup d-flex flex-column ">
                    <label htmlFor="username">
                      ...
                      />
                      {/* it is very important to put name as the right key for the donor data ; we use formdata in the value here so it is given in its newest state value that we change with every input in form */}
                    </label>
                    ...
                    <div className="button-container-main container d-flex">
                      <button className="bg-warning"
                        type="submit"
                        onClick={(e) =>
                          handleDonorEdit(e, donor.id, form_data)
                        }
                      >
                        <b>Submit</b>
                      </button>
...
export default DonorEditPopper;
