  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/admin/reg/requests" element={<AdminRegRequests />} />
        <Route path="/admin/post/requests" element={<AdminRequests />} />
        {/* <Route
        ...
        <Route path="/admin/anouncements" element={<AdminAnnouncements />} />
        ...
        <Route path="/donor/transactions" element={<DonorTransaction />} />
        <Route path="/details" element={<DetailsCard />} />
        <Route path="/creator/transactions" element={<CreatorTransaction />} />
      </Routes>
      <AppRoutes />
    </div>
  );
